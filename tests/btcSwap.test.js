...
import { mainnet } from 'simple/src/instances/bitcoin'
...
const btcSwap = new BtcSwap({
  ...
  fetchTxInfo: txid => mainnet().fetchTxInfo(txid),
})
...
test('btcSwap can estimate confidence factor', async () => {
  const result = await btcSwap.fetchTxInfo('9286321f9f2b9829352675ab1747fb9368129723e5b29853428c65b9f6ccfc38')
