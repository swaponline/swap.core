...
const SwapAuth = require('../core-connector').auth
const SwapRoom = require('../core-connector').room
const SwapOrders = require('../core-connector').orders

const { EthSwap, EthTokenSwap, BtcSwap, /*UsdtSwap,*/ } = require('../core-connector').swaps
const {
  ETH2BTC, BTC2ETH,
  ETHTOKEN2BTC, BTC2ETHTOKEN,
  /*USDT2ETHTOKEN, ETHTOKEN2USDT*/ } = require('../core-connector').flows
