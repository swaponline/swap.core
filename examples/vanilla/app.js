...
window.swap.app.SwapApp.setup({
  ...
  services: [
    new window.swap.auth.SwapAuth({
      eth: null, // or pass private key here
      btc: null,
    }),
    new window.swap.room.SwapRoom({
      EXPERIMENTAL: {
        pubsub: true,
      },
      config: {
    ...
    new window.swap.orders.SwapOrders(),
  ],
  swaps: [
    new window.swap.swaps.EthSwap({
    ...
    new window.swap.swaps.EthTokenSwap({
...
console.log(333, window.swap.app.SwapApp)
